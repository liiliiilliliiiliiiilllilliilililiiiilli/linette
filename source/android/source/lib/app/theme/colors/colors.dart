...
class AppColors extends ThemeExtension <AppColors> {
  ...
  final Color grey;
  final Color hint;
  final Color iconArrow;
  final Color iconArrowDrawerOption;
  final Color iconArrowNavigation;
  final Color iconInfo;
  final Color iconLocation;
  final Color iconMenu;
  final Color iconMoon;
  final Color iconSun;
  final Color iconTap;
  final Color iconWorld;
  final Color line;
  final Color link;
  ...
  const AppColors ({
    ...
    required this.iconArrowDrawerOption,
    required this.iconArrowNavigation,
    required this.iconInfo,
    required this.iconLocation,
    required this.iconMenu,
    required this.iconMoon,
    required this.iconSun,
    required this.iconTap,
    required this.iconWorld,
    required this.line,
    required this.link,
  ...
  static const darkGreen = AppColors (
    ...
    iconArrow: Color (0xff8b9e80),
    iconArrowDrawerOption: Color (0xff808080),
    iconArrowNavigation: Color (0xff808080),
    iconInfo: Color (0xff808080),
    iconLocation: Color (0xff8b9e80),
    iconMenu: Color (0xff808080),
    iconMoon: Color (0xff808080),
    iconSun: Color (0xff808080),
    iconTap: Color (0xff687262),
    iconWorld: Color (0xff808080),
  ...
  static const lightGreen = AppColors (
    ...
    grey: Color (0xff8b8b8b),
    hint: Color (0xff545454),
    iconArrow: Color (0xff000000),
    iconArrowDrawerOption: Color (0xff000000),
    iconArrowNavigation: Color (0xff404040),
    iconInfo: Color (0xff000000),
    iconLocation: Color (0xff000000),
    iconMenu: Color (0xff404040),
    iconMoon: Color (0xff404040),
    iconSun: Color (0xff404040),
    iconTap: Color (0xff000000),
    iconWorld: Color (0xff000000),
    line: Color (0xffcdcdcd),
    link: Color (0xff0645AD),
    linkPressed: Color (0xff1e3c6d),
    noiseBackground: Color (0xffd8e0d7),
  ...
  @override AppColors copyWith ({
    ...
    Color? hint,
    Color? iconArrow,
    Color? iconArrowDrawerOption,
    Color? iconArrowNavigation,
    Color? iconInfo,
    Color? iconLocation,
    Color? iconMenu,
    Color? iconMoon,
    ...
    return (
      ...
      AppColors (
        ...
        iconArrowDrawerOption: iconArrowDrawerOption ?? this.iconArrowDrawerOption,
        iconArrowNavigation: iconArrowNavigation ?? this.iconArrowNavigation,
        iconInfo: iconInfo ?? this.iconInfo,
        iconLocation: iconLocation ?? this.iconLocation,
        iconMenu: iconMenu ?? this.iconMenu,
        iconMoon: iconMoon ?? this.iconMoon,
        iconSun: iconSun ?? this.iconSun,
        iconTap: iconTap ?? this.iconTap,
        iconWorld: iconWorld ?? this.iconWorld,
        line: line ?? this.line,
        link: link ?? this.link,
  ...
  @override AppColors lerp (ThemeExtension <AppColors>? other, double t) {
    ...
    return (
      ...
      AppColors (
        ...
        iconArrow: Color.lerp (iconArrow, other.iconArrow, t) ?? iconArrow,
        iconArrowDrawerOption: Color.lerp (iconArrowDrawerOption, other.iconArrowDrawerOption, t) ?? iconArrowDrawerOption,
        iconArrowNavigation: Color.lerp (iconArrowNavigation, other.iconArrowNavigation, t) ?? iconArrowNavigation,
        iconInfo: Color.lerp (iconInfo, other.iconInfo, t) ?? iconInfo,
        iconLocation: Color.lerp (iconLocation, other.iconLocation, t) ?? iconLocation,
        iconMenu: Color.lerp (iconMenu, other.iconMenu, t) ?? iconMenu,
        iconMoon: Color.lerp (iconMoon, other.iconMoon, t) ?? iconMoon,
        iconSun: Color.lerp (iconSun, other.iconSun, t) ?? iconSun,
        iconTap: Color.lerp (iconTap, other.iconTap, t) ?? iconTap,
        iconWorld: Color.lerp (iconWorld, other.iconWorld, t) ?? iconWorld,
